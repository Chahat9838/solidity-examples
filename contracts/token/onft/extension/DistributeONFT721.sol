...
contract DistributeONFT721 is ONFT721 {
    ...
    constructor(string memory _name, string memory _symbol, address _layerZeroEndpoint, uint[] memory _indexArray, uint[] memory _valueArray) ONFT721(_name, _symbol, _layerZeroEndpoint){
